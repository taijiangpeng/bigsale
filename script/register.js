...
var yz_status = false;
var agree = false;
//验证码块phone_status pass_status pass_judge_status yz_status agree
...
kuai.onmousedown = function (ev){
    var e = ev || event;
    var to_left = e.clientX - kuai.offsetLeft;
    // var to_left = e.offsetX;
    var to_top = e.clientY - kuai.offsetTop;
    // var to_top = e.offsetY;
    document.onmousemove = function (ev){
        ...
        if(green.style.left == '0px'){
            green.innerHTML = '验证通过';
            // console.log(green.style.backgroundImage);
        ...
        console.log(green.style.left,g_l);
        // console.log(arrPos);
    }
